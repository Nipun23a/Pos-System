...
<div class="overlay" id="overlay">
    ...
    <div class="form-container">
        ...
        <form action="view_category.php" method="post" id="form">
            <h2 id="">Add New Category</h2>
            <div class="add-new-item-input">
            <input type="text" placeholder="Category Name" required name="category_name" class="input-box"><br>
            </div>
            <div class="button-container">
            <button type="reset" class="button" id="reset" onclick="closeForm()">Cancel</button>
            <button type="submit" class="button" id="submit" name="submit" onclick="submitForm()">Add Category</button>
            </div>
            <div id="message-container">
            <?php include("adding_new_category.php")?>
            </div>
    ...
    <?php include("side-panel.php");?>
        <form action="view_category.php" method="post">
            <div class="input-container">
                <input type="text" name="search_cateogry" id="input-box" placeholder="Category Name">
                <button type="submit" name="search_cateory_button" id="search">Search</button>
        ...
        <table class="data-table" id="resizeMe">
            <thead>
                <tr>
                    ...
                    <th class="resizable">Category Id</th>
                    <th class="resizable">Category Name</th>
                    <th class="resizable">Category Register Date</th>
            ...
            <tbody>
              ...
              $row_number=1;
                            ...
                            $category_result=mysqli_query($database_connection,$category_query);
                            if($category_result->num_rows>0){
                              while($row=$category_result->fetch_assoc()){
                                ...
                                <td>' . $row['category_registered_date'] . '</td>
                                <td>
                                <a href="view_category.php?delete=' . $row['category_id'] . '"class="btn btn-danger">Delete</a>
                                </td>
                                  </tr>';
                                $row_number++;
                    }
