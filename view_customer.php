        ...
        <table class="data-table" id="resizeMe">
            <thead>
                <tr>
                    ...
                    <th class="resizable">Customer Id</th>
                    <th class="resizable">Customer Name</th>
                    <th class="resizable">Customer Infomration</th>
                    <th class="resizable">Customer Credit</th>
                    <th class="resizable">Customer Credit Limit</th>
            ...
            <tbody>
              ...
              $row;
              $row_number=1;
                            $customer_query="SELECT * FROM customer_table";
                            $customer_result=mysqli_query($database_connection,$customer_query);
                            if($customer_result->num_rows>0){
                              while($row=$customer_result->fetch_assoc()){
                                ...
                                <td>
                                <a href="view_customer.php?delete=' . $row['customer_id'] . '"class="btn btn-danger">Delete</a>
                                <a href="view_customer.php?update=' . $row['customer_id'] . '"class="btn btn-success" id="update_button">Update</a>
                                </td>
                                  </tr>';
                                $row_number++;
                    }
